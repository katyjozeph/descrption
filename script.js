window.onload=()=>{
    ...
    const response = await fetch(`https://finish-api.onrender.com/api/gove/${governorateID}`)
        ...
        governorateData2.historicalsites.forEach((hist, index) => {
            ...
            const merkUp = `
                <div class="Museum card crd" style="width: 20rem;">
                    <img src="https://drive.google.com/file/d/${img}/view?usp=drive_link" class="card-img-top" alt="${historicalname}">
